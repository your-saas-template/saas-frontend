...
import {
  ...
  type DailyRevenue,
} from "@packages/api/modules/analytics/business";
...
import { StatCard } from "@/shared/components/analytics/StatCard";
import { LineChart } from "@/shared/components/analytics/LineChart";
import { BarChart } from "@/shared/components/analytics/BarChart";
import { DateRange, DateRangeInput } from "@/shared/components/analytics/DateRangeInput";
import { useAppPermissions } from "@/hooks/auth/usePermissions";
import { usePermissionGuard } from "@/hooks/auth/usePermissionGuard";


export default function BusinessAnalyticsClientPage() {
  ...
  const { data, isLoading, isError, refetch } = useBusinessAnalytics(apiRange);
