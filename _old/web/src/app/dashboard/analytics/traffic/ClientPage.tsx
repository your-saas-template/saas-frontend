...
import {
  TrafficEventType,
  useTrafficEvents,
} from "@packages/api/modules/analytics/traffic";
...
import { DateRangeInput } from "@/shared/components/analytics/DateRangeInput";
import { useAppPermissions } from "@/hooks/auth/usePermissions";
import { usePermissionGuard } from "@/hooks/auth/usePermissionGuard";

export default function TrafficAnalyticsClientPage() {
  ...
  const { data, isLoading, isError, refetch } = useTrafficEvents(apiRange);
