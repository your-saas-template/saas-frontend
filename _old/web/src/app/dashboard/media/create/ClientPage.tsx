...
export default function MediaCreateClientPage() {
  const { t } = useI18n();
    ...
    uploadMedia.mutate(
      ...
      },
      {
        ...
        onError: (err: any) => {
          ...
          setError(message || t(messages.errors.generic));
        },
      },
    );
  };
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            >
              <Input
                ...
                placeholder={t(messages.dashboard.media.create.descriptionPlaceholder)}
                disabled={uploadMedia.isPending}
              />
            </Field>
