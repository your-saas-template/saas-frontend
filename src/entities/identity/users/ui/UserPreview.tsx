        ...
        <div className="flex flex-row flex-wrap gap-2">
          ...
          {showPlan && user?.plan && (
            <Tooltip
              ...
              placement={TooltipPosition.bottom}
            >
              <span className="inline-flex shrink-0 items-center rounded-full border border-border/60 bg-muted/40 px-2 py-[2px] text-[10px] font-medium uppercase tracking-wide text-text">
                {planLabel}
              </span>
            </Tooltip>
          )}
